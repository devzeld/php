...
try {
    ...
    $conn = $pdo->query("CREATE TABLE IF NOT EXISTS users(mail VARCHAR(255) UNIQUE, id int NOT NULL PRIMARY KEY AUTO_INCREMENT , username VARCHAR(255) NOT NULL UNIQUE, name VARCHAR(255), surname VARCHAR(255), password VARCHAR(255), create_time DATETIME);");
